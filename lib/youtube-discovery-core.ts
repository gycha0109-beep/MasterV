...
export function parseIso8601DurationSeconds(value: string | undefined) {
...
export async function discoverYouTubeCandidatesWithKey(
  query: string,
  ...
  const provider = new YouTubeDiscoveryProvider(dependencies.api_key, countingFetcher);
