(() => {
  ...
  function safePolarDiagnostic(error) {
    ...
    const upstreamReason = raw.match(/\[upstream_reason=(?:insufficient_scope|activation_limit_reached|license_inactive|license_expired|activation_not_supported|organization_token_unauthorized|not_permitted)\]/);
